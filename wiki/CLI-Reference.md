...
| `--icon-symbol-palette` | `c1,c2,c3` | `red,green,yellow` | Palette-mode colours; every slot accepts an `:opacity` suffix. |
...
| `--badge-symbol-palette` | `c1,c2,c3` | `red,green,yellow` | Badge palette-mode colours. |
