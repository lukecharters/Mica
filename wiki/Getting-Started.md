...
- Flick on **Show Advanced Controls** (**View** menu, or **Mica ▸ Settings…**, ⌘,) to split each group into Foreground and Background layers and reveal imported images, rendering modes, symbol weights, corner styles, and more.
