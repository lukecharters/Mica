...
| `icon-fg-offset-x-minus0.15.png` | `icon-fg-offset-x` | `minus0.15` | `mica-cli --icon-symbol star.fill --size 256 --icon-fg-offset-x=-0.15` |
| `icon-fg-offset-x-0.png` | `icon-fg-offset-x` | `0` | `mica-cli --icon-symbol star.fill --size 256 --icon-fg-offset-x=0` |
| `icon-fg-offset-x-0.15.png` | `icon-fg-offset-x` | `0.15` | `mica-cli --icon-symbol star.fill --size 256 --icon-fg-offset-x=0.15` |
| `icon-fg-offset-y-minus0.15.png` | `icon-fg-offset-y` | `minus0.15` | `mica-cli --icon-symbol star.fill --size 256 --icon-fg-offset-y=-0.15` |
| `icon-fg-offset-y-0.png` | `icon-fg-offset-y` | `0` | `mica-cli --icon-symbol star.fill --size 256 --icon-fg-offset-y=0` |
| `icon-fg-offset-y-0.15.png` | `icon-fg-offset-y` | `0.15` | `mica-cli --icon-symbol star.fill --size 256 --icon-fg-offset-y=0.15` |
...
| `badge-fg-offset-x-minus0.3.png` | `badge-fg-offset-x` | `minus0.3` | `mica-cli --icon-symbol star.fill --badge-symbol plus --size 512 --badge-fg-offset-x=-0.3` |
| `badge-fg-offset-x-0.png` | `badge-fg-offset-x` | `0` | `mica-cli --icon-symbol star.fill --badge-symbol plus --size 512 --badge-fg-offset-x=0` |
| `badge-fg-offset-x-0.3.png` | `badge-fg-offset-x` | `0.3` | `mica-cli --icon-symbol star.fill --badge-symbol plus --size 512 --badge-fg-offset-x=0.3` |
| `badge-fg-offset-y-minus0.3.png` | `badge-fg-offset-y` | `minus0.3` | `mica-cli --icon-symbol star.fill --badge-symbol plus --size 512 --badge-fg-offset-y=-0.3` |
| `badge-fg-offset-y-0.png` | `badge-fg-offset-y` | `0` | `mica-cli --icon-symbol star.fill --badge-symbol plus --size 512 --badge-fg-offset-y=0` |
| `badge-fg-offset-y-0.3.png` | `badge-fg-offset-y` | `0.3` | `mica-cli --icon-symbol star.fill --badge-symbol plus --size 512 --badge-fg-offset-y=0.3` |
