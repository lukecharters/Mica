...
// ContentView.swift on 2026-07-28 — the project notes had to write "ScaledIconPreview
// (in ContentView.swift)" to help anyone find it.
//
// The pure render view it wraps is IconContentView; per the project notes, gestures and
